...
<div class="evolvewp-clientjourney-ui-section">
    <h3><?php esc_html_e('Chart Visualization', 'evolvewp-clientjourney'); ?></h3>
    <p><?php esc_html_e('Chart components for financial data visualization, trading patterns, and performance monitoring using existing evolvewp-clientjourney styles.', 'evolvewp-clientjourney'); ?></p>
    
    <div class="evolvewp-clientjourney-component-group">
        <!-- Candlestick Chart Placeholder -->
        <div class="component-demo">
            <h4><?php esc_html_e('Candlestick Chart', 'evolvewp-clientjourney'); ?></h4>
            <div class="evolvewp-clientjourney-component-showcase">
                <div class="chart-card">
                    <div class="chart-card-header">
                        <h5><?php esc_html_e('AAPL - Apple Inc.', 'evolvewp-clientjourney'); ?></h5>
                        <div class="chart-controls">
                            <select class="chart-period-select">
                                <option value="1d"><?php esc_html_e('1D', 'evolvewp-clientjourney'); ?></option>
                                <option value="1w" selected><?php esc_html_e('1W', 'evolvewp-clientjourney'); ?></option>
                                <option value="1m"><?php esc_html_e('1M', 'evolvewp-clientjourney'); ?></option>
                                <option value="3m"><?php esc_html_e('3M', 'evolvewp-clientjourney'); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="chart-card-body">
                        <div class="candlestick-chart-placeholder">
                            ...
                            <div class="chart-placeholder-text">
                                ...
                                <?php esc_html_e('Interactive candlestick chart would be rendered here', 'evolvewp-clientjourney'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="chart-card-footer">
                        <div class="chart-metrics">
                            <div class="chart-metric">
                                <span class="metric-label"><?php esc_html_e('Open', 'evolvewp-clientjourney'); ?></span>
                                <span class="metric-value">$168.22</span>
                            </div>
                            <div class="chart-metric">
                                <span class="metric-label"><?php esc_html_e('High', 'evolvewp-clientjourney'); ?></span>
                                <span class="metric-value positive">$172.45</span>
                            </div>
                            <div class="chart-metric">
                                <span class="metric-label"><?php esc_html_e('Low', 'evolvewp-clientjourney'); ?></span>
                                <span class="metric-value negative">$166.80</span>
                            </div>
                            <div class="chart-metric">
                                <span class="metric-label"><?php esc_html_e('Close', 'evolvewp-clientjourney'); ?></span>
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Performance Line Chart', 'evolvewp-clientjourney'); ?></h4>
            <div class="evolvewp-clientjourney-component-showcase">
                <div class="chart-card">
                    <div class="chart-card-header">
                        <h5><?php esc_html_e('Portfolio Performance', 'evolvewp-clientjourney'); ?></h5>
                        <div class="chart-toolbar">
                            <button class="chart-tool-button active" title="<?php esc_attr_e('Line Chart', 'evolvewp-clientjourney'); ?>">
                                <span class="dashicons dashicons-chart-line"></span>
                            </button>
                            <button class="chart-tool-button" title="<?php esc_attr_e('Area Chart', 'evolvewp-clientjourney'); ?>">
                                <span class="dashicons dashicons-chart-area"></span>
                            </button>
                            <select class="chart-timeframe-selector">
                                <option value="ytd"><?php esc_html_e('YTD', 'evolvewp-clientjourney'); ?></option>
                                <option value="1y" selected><?php esc_html_e('1Y', 'evolvewp-clientjourney'); ?></option>
                                <option value="5y"><?php esc_html_e('5Y', 'evolvewp-clientjourney'); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="chart-card-body">
                        <div class="line-chart-placeholder">
                            ...
                            <div class="chart-placeholder-overlay">
                                <span class="dashicons dashicons-chart-line"></span>
                                <?php esc_html_e('Interactive line chart would be rendered here', 'evolvewp-clientjourney'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="chart-card-footer">
                        <div class="chart-legend">
                            <div class="chart-legend-item">
                                ...
                                <span class="legend-text"><?php esc_html_e('Portfolio Value', 'evolvewp-clientjourney'); ?></span>
                            </div>
                            <div class="chart-legend-item">
                                <span class="legend-color" style="background-color: #2271b1;"></span>
                                <span class="legend-text"><?php esc_html_e('Benchmark (S&P 500)', 'evolvewp-clientjourney'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Sector Performance Bar Chart', 'evolvewp-clientjourney'); ?></h4>
            <div class="evolvewp-clientjourney-component-showcase">
                <div class="chart-card">
                    <div class="chart-card-header">
                        <h5><?php esc_html_e('Sector Performance (YTD)', 'evolvewp-clientjourney'); ?></h5>
                    </div>
                    <div class="chart-card-body">
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Asset Allocation Pie Chart', 'evolvewp-clientjourney'); ?></h4>
            <div class="evolvewp-clientjourney-component-showcase">
                <div class="chart-card">
                    <div class="chart-card-header">
                        <h5><?php esc_html_e('Portfolio Allocation', 'evolvewp-clientjourney'); ?></h5>
                    </div>
                    <div class="chart-card-body">
                        <div class="pie-chart-container">
                            <div class="pie-chart">
                                ...
                                <div class="pie-chart-center">
                                    ...
                                    <div class="pie-chart-label"><?php esc_html_e('Total', 'evolvewp-clientjourney'); ?></div>
                                </div>
                            </div>
                            <div class="pie-chart-legend">
                                <div class="pie-legend-item">
                                    <span class="pie-legend-color" style="background-color: #2271b1;"></span>
                                    <span class="pie-legend-text"><?php esc_html_e('Stocks (45%)', 'evolvewp-clientjourney'); ?></span>
                                </div>
                                <div class="pie-legend-item">
                                    <span class="pie-legend-color" style="background-color: #00ba37;"></span>
                                    <span class="pie-legend-text"><?php esc_html_e('Bonds (25%)', 'evolvewp-clientjourney'); ?></span>
                                </div>
                                <div class="pie-legend-item">
                                    <span class="pie-legend-color" style="background-color: #dba617;"></span>
                                    <span class="pie-legend-text"><?php esc_html_e('ETFs (18%)', 'evolvewp-clientjourney'); ?></span>
                                </div>
                                <div class="pie-legend-item">
                                    <span class="pie-legend-color" style="background-color: #d63638;"></span>
                                    <span class="pie-legend-text"><?php esc_html_e('Cash (12%)', 'evolvewp-clientjourney'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Stock Performance Heatmap', 'evolvewp-clientjourney'); ?></h4>
            <div class="evolvewp-clientjourney-component-showcase">
                <div class="heatmap-container">
                    <div class="heatmap-header">
                        <h5><?php esc_html_e('Top Holdings Performance', 'evolvewp-clientjourney'); ?></h5>
                    </div>
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Technical Indicators Dashboard', 'evolvewp-clientjourney'); ?></h4>
            <div class="evolvewp-clientjourney-component-showcase">
                <div class="evolvewp-clientjourney-grid evolvewp-clientjourney-grid-2-cols">
                    <div class="indicator-card">
                        <div class="indicator-header">
                            <h5><?php esc_html_e('RSI (14)', 'evolvewp-clientjourney'); ?></h5>
                            <span class="indicator-value positive">65.2</span>
                        </div>
                        <div class="indicator-body">
                            <div class="indicator-description">
                                <p><?php esc_html_e('Relative Strength Index indicates momentum', 'evolvewp-clientjourney'); ?></p>
                            </div>
                    ...
                    <div class="indicator-card">
                        <div class="indicator-header">
                            <h5><?php esc_html_e('MACD', 'evolvewp-clientjourney'); ?></h5>
                            <span class="indicator-value positive">+0.24</span>
                        </div>
                        <div class="indicator-body">
                            <div class="indicator-description">
                                <p><?php esc_html_e('Moving Average Convergence Divergence', 'evolvewp-clientjourney'); ?></p>
                            </div>
                            <div class="indicator-interpretation">
                                <h6><?php esc_html_e('Signal:', 'evolvewp-clientjourney'); ?></h6>
                                <ul>
                                    <li class="bullish"><?php esc_html_e('Bullish crossover detected', 'evolvewp-clientjourney'); ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="indicator-card">
                        <div class="indicator-header">
                            <h5><?php esc_html_e('Bollinger Bands', 'evolvewp-clientjourney'); ?></h5>
                            <span class="indicator-value warning">Near Upper</span>
                        </div>
                        <div class="indicator-body">
                            <div class="indicator-description">
                                <p><?php esc_html_e('Price approaching upper resistance band', 'evolvewp-clientjourney'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="indicator-card">
                        <div class="indicator-header">
                            <h5><?php esc_html_e('Volume MA', 'evolvewp-clientjourney'); ?></h5>
                            <span class="indicator-value positive">Above Avg</span>
                        </div>
                        <div class="indicator-body">
                            <div class="indicator-description">
                                <p><?php esc_html_e('Trading volume above 20-day average', 'evolvewp-clientjourney'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    wp_add_inline_script('jquery', $evolvewp_cj_chart_script);
    ?>
</div>
