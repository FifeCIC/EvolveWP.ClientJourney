        ...
        <div class="component-demo">
            ...
            <div class="control-panel control-panel-expanded">
                ...
                <div class="control-panel-footer">
                    <button class="tp-button tp-button-small tp-button-secondary"><?php esc_html_e('Reset', 'evolvewp-clientjourney'); ?></button>
                    <button class="tp-button tp-button-small tp-button-primary"><?php esc_html_e('Apply', 'evolvewp-clientjourney'); ?></button>
                </div>
            </div>
        </div>
    </div>
