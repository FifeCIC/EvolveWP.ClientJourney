/**
 * EvolveWP ClientJourney — Help Tooltips
 *
 ...
 *   <span class="evolvewp-clientjourney-help-tip" data-tooltip="Explanation text">
 *       <span class="dashicons dashicons-editor-help"></span>
 *   </span>
 *
 * @package evolvewp-clientjourney/JS/Admin
 * @since   3.1.0
 */
...
( function( $ ) {
	...
	function showTooltip( trigger ) {
		...
		tooltip.className = 'evolvewp-clientjourney-help-tooltip evolvewp-clientjourney-help-tooltip--top';
		...
		if ( top < scrollTop ) {
			...
			tooltip.className = 'evolvewp-clientjourney-help-tooltip evolvewp-clientjourney-help-tooltip--bottom';
		}
		...
		tooltip.classList.add( 'evolvewp-clientjourney-visible' );
	 ...
	 */
	function init() {
		var triggers = document.querySelectorAll( '.evolvewp-clientjourney-help-tip, [data-tooltip]' );
