<?php
/**
 * EvolveWP ClientJourney Asset Management
 * 
...
class EvolveWP_CJ_Asset_Manager {
    ...
    private function log_missing_asset($type, $name, $path) {
        ...
        if (get_option('evolvewp_cj_log_missing_assets', 'yes') === 'yes') {
            EvolveWP_CJ_Logging_Helper::log_error(
                'missing_asset',
...
if (!isset($evolvewp_cj_assets)) {
    $evolvewp_cj_assets = new EvolveWP_CJ_Asset_Manager();
}

function evolvewp_cj_get_asset($type, $name) {
    global $evolvewp_cj_assets;
    return $evolvewp_cj_assets->get_asset_path($type, $name);
}

function evolvewp_cj_get_asset_url($type, $name) {
    global $evolvewp_cj_assets;
    return $evolvewp_cj_assets->get_asset_url($type, $name);
}
