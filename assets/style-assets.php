<?php
/**
 * EvolveWP ClientJourney Style Assets Registry
 *
 ...
 *   - 'evolvewp_cj_development' → loads only on the Development page
...
return array(
	...
	'layouts' => array(
		...
		'features-layout' => array(
			...
			'pages'        => array( 'evolvewp_cj_settings' ),
			'dependencies' => array( 'variables' ),
		),
	...
	'pages' => array(
		'dashboard' => array(
			...
			'pages'        => array( 'evolvewp_cj_dashboard', 'toplevel_page_evolvewp-clientjourney' ),
			'dependencies' => array( 'variables' ),
		),
		...
		'settings-general' => array(
			...
			'pages'        => array( 'evolvewp_cj_settings', 'evolvewp-clientjourney-settings' ),
			'dependencies' => array( 'variables' ),
		),
		...
		'setup' => array(
			...
			'pages'        => array( 'evolvewp_cj_setup', 'evolvewp-clientjourney-setup' ),
			'dependencies' => array( 'variables' ),
		),
		'assets-page' => array(
	...
	'standalone' => array(
		...
		'evolvewp-clientjourney-setup' => array(
			'path'         => 'css/evolvewp-clientjourney-setup.css',
