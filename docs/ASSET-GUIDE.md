...
```css
/* Primary brand */
--evolvewp-clientjourney-color-primary        /* #2271b1 — WordPress blue */
--evolvewp-clientjourney-color-primary-dark
--evolvewp-clientjourney-color-primary-light

/* Accent (secondary brand) */
--evolvewp-clientjourney-color-accent
--evolvewp-clientjourney-color-accent-dark
--evolvewp-clientjourney-color-accent-light

/* Semantic */
--evolvewp-clientjourney-color-success         /* Green */
--evolvewp-clientjourney-color-warning         /* Amber */
--evolvewp-clientjourney-color-error           /* Red */
--evolvewp-clientjourney-color-info            /* Blue */

/* Neutral scale */
--evolvewp-clientjourney-color-gray-50 through --evolvewp-clientjourney-color-gray-900
--evolvewp-clientjourney-color-white
--evolvewp-clientjourney-color-black

/* Status backgrounds (for notice boxes) */
--evolvewp-clientjourney-status-success-bg / -border / -text
--evolvewp-clientjourney-status-warning-bg / -border / -text
--evolvewp-clientjourney-status-error-bg   / -border / -text
--evolvewp-clientjourney-status-info-bg    / -border / -text
```

### Spacing tokens

```css
--evolvewp-clientjourney-spacing-xs    /* 4px */
--evolvewp-clientjourney-spacing-sm    /* 8px */
--evolvewp-clientjourney-spacing-md    /* 12px */
--evolvewp-clientjourney-spacing-lg    /* 16px */
--evolvewp-clientjourney-spacing-xl    /* 20px */
--evolvewp-clientjourney-spacing-2xl   /* 24px */
--evolvewp-clientjourney-spacing-3xl   /* 32px */
```

### Typography tokens

```css
--evolvewp-clientjourney-font-family-base   /* System font stack */
--evolvewp-clientjourney-font-family-mono   /* Consolas, Monaco, monospace */
--evolvewp-clientjourney-font-size-xs through --evolvewp-clientjourney-font-size-3xl
--evolvewp-clientjourney-font-weight-normal / -medium / -semibold / -bold
--evolvewp-clientjourney-line-height-tight / -normal / -relaxed
```
...
```css
/* Borders */
--evolvewp-clientjourney-border-radius / -sm / -md / -lg / -xl / -full
--evolvewp-clientjourney-border-standard   /* 1px solid gray-300 */

/* Shadows */
--evolvewp-clientjourney-shadow-sm / (default) / -md / -lg / -xl

/* Transitions */
--evolvewp-clientjourney-transition-fast / -normal / -slow

/* Focus (accessibility) */
--evolvewp-clientjourney-focus-ring          /* 2px solid primary */
--evolvewp-clientjourney-focus-ring-offset   /* 1px */

/* Z-index scale */
--evolvewp-clientjourney-z-index-dropdown / -modal / -popover / -tooltip / -toast
```
...
All CSS classes use the `.evolvewp-clientjourney-` prefix to avoid conflicts with themes
and other plugins. When cloned, the prefix changes to the plugin's own
(e.g. `.evolvewp-clientjourney-`).

Pattern: `.evolvewp-clientjourney-{component}-{element}--{modifier}`

```css
/* Component */
.evolvewp-clientjourney-card { }

/* Element within component */
.evolvewp-clientjourney-card-header { }
.evolvewp-clientjourney-card-body { }
.evolvewp-clientjourney-card-footer { }

/* Modifier */
.evolvewp-clientjourney-card-interactive { }

/* State */
.evolvewp-clientjourney-button:disabled { }
.evolvewp-clientjourney-button-loading { }
```
...
2. `EvolveWP_CJ_Asset_Queue` detects the current admin page slug
...
| `'evolvewp_cj_development'` | Development page only |
| `'evolvewp_cj_settings'` | Settings page only |
| `'evolvewp_cj_dashboard'` | Dashboard page only |
...
'my-component' => array(
    ...
    'pages'        => array( 'evolvewp_cj_development' ),
...
These are the components every plugin inherits. They use `--evolvewp-clientjourney-*` variables
...
1. All `.evolvewp-clientjourney-` class prefixes become your plugin's prefix
2. All `--evolvewp-clientjourney-` CSS variables become your plugin's prefix
