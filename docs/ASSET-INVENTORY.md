...
| `reset.css` | core | Yes | All --tp- refs need replacing with --evolvewp-clientjourney- |
| `typography.css` | core | Yes | All --tp- refs need replacing with --evolvewp-clientjourney- |
...
| `evolvewp-clientjourney-setup.css` | core | Setup wizard |
| `evolvewp-clientjourney-setup.scss` | **dead** | SCSS source — no build pipeline |
...
| `js/admin/evolvewp-clientjourney-enhanced-select.js` | core | Select2 wrapper |
| `js/admin/evolvewp-clientjourney-enhanced-select.min.js` | core | Minified version |
| `js/admin/evolvewp-clientjourney-faq.js` | feature | FAQ accordion |
| `js/admin/evolvewp-clientjourney-faq.min.js` | feature | Minified version |
| `js/admin/evolvewp-clientjourney-setup.js` | core | Setup wizard JS |
| `js/admin/evolvewp-clientjourney-setup.min.js` | core | Minified version |
...
- **Task 7.2** ✅ — All `--tp-` variable refs replaced with `--evolvewp-clientjourney-` (46 CSS files)
- **Task 7.2** ✅ — All `.tp-` class names replaced with `.evolvewp-clientjourney-` (6 CSS, 1 JS, 7 PHP templates)
- **Task 7.3** ✅ — `variables.css` cleaned: removed self-referencing aliases, trading vars,
  duplicate swatches. Added `--evolvewp-clientjourney-focus-ring` and `--evolvewp-clientjourney-color-accent`.
