...
```php
array(
    'title'           => __( 'Social Media Links', 'evolvewp-clientjourney' ),
    'desc'            => __( 'Add your social media profiles.', 'evolvewp-clientjourney' ),
    'id'              => 'evolvewp_cj_social_links',
    'type'            => 'repeater',
    'item_title'      => __( 'Social Link', 'evolvewp-clientjourney' ),
    'add_button_text' => __( 'Add Social Link', 'evolvewp-clientjourney' ),
    'fields'          => array(
        array(
            'id'          => 'platform',
            'label'       => __( 'Platform', 'evolvewp-clientjourney' ),
            'type'        => 'text',
            'placeholder' => __( 'e.g., Facebook', 'evolvewp-clientjourney' ),
        ),
        array(
            'id'          => 'url',
            'label'       => __( 'Profile URL', 'evolvewp-clientjourney' ),
            'type'        => 'url',
            'placeholder' => __( 'https://...', 'evolvewp-clientjourney' ),
        ),
    ),
)
```
...
```php
array(
    'title'           => __( 'API Credentials', 'evolvewp-clientjourney' ),
    'desc'            => __( 'Add multiple API credentials.', 'evolvewp-clientjourney' ),
    'id'              => 'evolvewp_cj_api_credentials',
    'type'            => 'repeater',
    'item_title'      => __( 'API Credential', 'evolvewp-clientjourney' ),
    'add_button_text' => __( 'Add API Credential', 'evolvewp-clientjourney' ),
    'fields'          => array(
        array(
            'id'          => 'service_name',
            'label'       => __( 'Service Name', 'evolvewp-clientjourney' ),
            'type'        => 'text',
            'placeholder' => __( 'e.g., Stripe', 'evolvewp-clientjourney' ),
        ),
        array(
            'id'          => 'api_key',
            'label'       => __( 'API Key', 'evolvewp-clientjourney' ),
            'type'        => 'text',
        ),
        array(
            'id'      => 'environment',
            'label'   => __( 'Environment', 'evolvewp-clientjourney' ),
            'type'    => 'select',
            'options' => array(
                'sandbox'    => __( 'Sandbox', 'evolvewp-clientjourney' ),
                'production' => __( 'Production', 'evolvewp-clientjourney' ),
            ),
            'default' => 'sandbox',
        ),
        array(
            'id'          => 'enabled',
            'type'        => 'checkbox',
            'description' => __( 'Enable this credential', 'evolvewp-clientjourney' ),
            'default'     => 1,
        ),
    ),
)
...
```php
$items = get_option( 'evolvewp_cj_social_links', array() );
...
```php
$items = EvolveWP_CJ_Admin_Settings::get_option( 'evolvewp_cj_social_links', array() );
```
...
```css
.evolvewp-clientjourney-repeater-item {
    /* Custom item styling */
}

.evolvewp-clientjourney-repeater-item-header {
...
```javascript
jQuery(document).on('evolvewp_cj_repeater_item_added', function(e, $item) {
    // Item was added
});

jQuery(document).on('evolvewp_cj_repeater_item_removed', function(e, $item) {
    // Item was removed
});
```
...
- GitHub Issues: https://github.com/ryanbayne/evolvewp-clientjourney/issues
- Documentation: https://github.com/ryanbayne/evolvewp-clientjourney/docs
