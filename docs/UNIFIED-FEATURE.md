...
All implementations use the **same core rendering function**: `EvolveWP_CJ_Unified_Feature::render_content()`
...
```
[evolvewp_cj_feature]
[evolvewp_cj_feature title="Custom Title"]
[evolvewp_cj_feature show_icon="no"]
[evolvewp_cj_feature show_stats="no"]
```
