 ...
 * namespace configuration, and REST Bridge integration for all EvolveWP ClientJourney REST
 * API endpoints. Concrete controllers extend this and implement register_routes().
 *
 * DEPENDS ON:
 *   - WordPress WP_REST_Controller class
 *   - EvolveWP ClientJourney\API\REST_Bridge (for register_endpoint convenience method)
 *
 * CONSUMED BY:
...
abstract class REST_Controller extends \WP_REST_Controller {
	 ...
	 * @var   string
	 */
	protected $namespace = 'evolvewp-clientjourney/v1';
