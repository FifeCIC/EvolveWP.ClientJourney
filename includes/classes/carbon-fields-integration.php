<?php
/**
 * EvolveWP ClientJourney Carbon Fields Integration
 *
...
class EvolveWP_CJ_Carbon_Fields {
    ...
    public function register_fields() {
        ...
        do_action('evolvewp_cj_carbon_fields_register');
    }
...
add_action('init', function() {
    EvolveWP_CJ_Carbon_Fields::instance();
});
