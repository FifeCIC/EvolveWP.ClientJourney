...
class EvolveWP_CJ_Ecosystem_Installer {
    ...
    private function define_available_plugins() {
        $this->available_plugins = apply_filters('evolvewp_cj_ecosystem_available_plugins', array(
            'evolvewp-clientjourney' => array(
                ...
                'download_url' => 'https://github.com/yourusername/evolvewp-clientjourney/archive/main.zip',
                'required_by' => array(),
                'integrates_with' => array('evolvewp-clientjourney'),
            ),
    ...
    public function render_installer_page() {
        ...
        <div class="wrap">
            ...
            <p><?php esc_html_e('Install related Ryan Bayne plugins with one click', 'evolvewp-clientjourney'); ?></p>
...
return new EvolveWP_CJ_Ecosystem_Installer();
