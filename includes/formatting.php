<?php
/**
 * EvolveWP ClientJourney - Data Formatting Functions
 *
 * @author   Ryan Bayne
 * @category Core
...
* @version 1.0
*/
function evolvewp_cj_string_half( $string, $ret = null ) {        
    $a = array();
 ...
 */
function evolvewp_cj_normalize_postcode( $postcode ) {          
 ...
 * @return string
 */
function evolvewp_cj_format_phone_number( $tel ) {            
 ...
 * @return string
 */
function evolvewp_cj_strtolower( $string ) {                    
 ...
 * @return string
 */
function evolvewp_cj_trim_string( $string, $chars = 200, $suffix = '...' ) {      
 ...
 * @return string|array
 */
function evolvewp_cj_clean( $var ) {
    if ( is_array( $var ) ) {
        return array_map( 'evolvewp_cj_clean', $var );
    } else {
