<?php
/**
 * EvolveWP ClientJourney - Validation Functions
 *
...
* @return boolean 
*/
function evolvewp_cj_is_extensionloaded( $giving_extension ){      
...
* @param url $url
*/
function evolvewp_cj_is_url( $url ){            
...
* @returns boolean
*/
function evolvewp_cj_is_decimalnumber( $img_url){       
...
* @returns boolean
*/
function evolvewp_cj_is_image_url( $img_url ){       
