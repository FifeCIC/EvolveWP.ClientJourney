...
<div class="evolvewp-clientjourney-ui-section">
    ...
    <div class="evolvewp-clientjourney-component-group">
        ...
        <div class="component-demo">
            ...
            <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-primary" id="open-demo-modal"><?php esc_html_e('Open Modal', 'evolvewp-clientjourney'); ?></button>
            ...
            <div id="ui-library-demo-modal" class="evolvewp-clientjourney-modal" style="display:none;">
                <div class="evolvewp-clientjourney-modal-content">
                    ...
                    <div class="evolvewp-clientjourney-modal-footer">
                        <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-secondary close-demo-modal"><?php esc_html_e('Cancel', 'evolvewp-clientjourney'); ?></button>
                        <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-primary"><?php esc_html_e('Save Changes', 'evolvewp-clientjourney'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="component-demo">
            ...
            <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-secondary" id="open-task-modal"><?php esc_html_e('View Task Details', 'evolvewp-clientjourney'); ?></button>
            ...
            <div id="ui-library-task-modal" class="evolvewp-clientjourney-modal" style="display:none;">
                <div class="evolvewp-clientjourney-modal-content">
                    ...
                    <div class="evolvewp-clientjourney-modal-footer">
                        <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-secondary close-task-modal"><?php esc_html_e('Close', 'evolvewp-clientjourney'); ?></button>
                        <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-primary"><?php esc_html_e('Edit Task', 'evolvewp-clientjourney'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="component-demo">
            ...
            <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-secondary" id="open-loading-modal"><?php esc_html_e('Show Loading', 'evolvewp-clientjourney'); ?></button>
        ...
        <div class="component-demo">
            ...
            <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-danger" id="open-confirm-modal"><?php esc_html_e('Delete Item', 'evolvewp-clientjourney'); ?></button>
            ...
            <div id="ui-library-confirm-modal" class="evolvewp-clientjourney-modal" style="display:none;">
                <div class="evolvewp-clientjourney-modal-content">
                    ...
                    <div class="evolvewp-clientjourney-modal-footer">
                        <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-secondary close-confirm-modal"><?php esc_html_e('Cancel', 'evolvewp-clientjourney'); ?></button>
                        <button class="evolvewp-clientjourney-button evolvewp-clientjourney-button-danger"><?php esc_html_e('Delete', 'evolvewp-clientjourney'); ?></button>
                    </div>
                </div>
            </div>
        </div>
