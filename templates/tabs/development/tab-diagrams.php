<?php
/**
 * EvolveWP ClientJourney Development Diagrams View
 *
...
class EvolveWP_CJ_Admin_Development_Diagrams {
    
    public static function output() {
        // Enqueue local Mermaid.js (download from https://cdn.jsdelivr.net/npm/mermaid@10/dist/mermaid.min.js)
        wp_enqueue_script('mermaid', EVOLVEWP_CJ_PLUGIN_URL . 'assets/js/mermaid.min.js', array(), '10.0.0', true);
        ?>
        <div class="evolvewp-clientjourney-diagrams-container">
            <div class="diagrams-header">
                <h2><?php esc_html_e('EvolveWP ClientJourney System Diagrams', 'evolvewp-clientjourney'); ?></h2>
                <p><?php esc_html_e('Visual diagrams showing plugin architecture, data flow, and system processes.', 'evolvewp-clientjourney'); ?></p>
            </div>
            
            <div class="diagram-controls">
                <select id="diagram-selector" class="regular-text">
                    <optgroup label="Architecture">
                        <option value="plugin-structure"><?php esc_html_e('Plugin Structure', 'evolvewp-clientjourney'); ?></option>
                        <option value="class-hierarchy"><?php esc_html_e('Class Hierarchy', 'evolvewp-clientjourney'); ?></option>
                        <option value="hook-system"><?php esc_html_e('Hook System', 'evolvewp-clientjourney'); ?></option>
                    </optgroup>
                    <optgroup label="Data Flow">
                        <option value="data-flow"><?php esc_html_e('Data Flow Architecture', 'evolvewp-clientjourney'); ?></option>
                        <option value="rest-api-flow"><?php esc_html_e('REST API Flow', 'evolvewp-clientjourney'); ?></option>
                        <option value="admin-flow"><?php esc_html_e('Admin Interface Flow', 'evolvewp-clientjourney'); ?></option>
                    </optgroup>
                    <optgroup label="Systems">
                        <option value="logging-system"><?php esc_html_e('Logging System', 'evolvewp-clientjourney'); ?></option>
                        <option value="ai-integration"><?php esc_html_e('AI Integration', 'evolvewp-clientjourney'); ?></option>
                        <option value="asset-management"><?php esc_html_e('Asset Management', 'evolvewp-clientjourney'); ?></option>
                    </optgroup>
                </select>
                <button id="fullscreen-btn" class="button"><?php esc_html_e('Fullscreen', 'evolvewp-clientjourney'); ?></button>
                <button id="export-btn" class="button"><?php esc_html_e('Export SVG', 'evolvewp-clientjourney'); ?></button>
            </div>
        ...
        <style>
        .evolvewp-clientjourney-diagrams-container { max-width: 100%; margin: 20px 0; }
        ...
        jQuery(document).ready(function($) {
            ...
            const diagrams = {
                'plugin-structure': {
                    ...
                    description: 'File and folder organization of EvolveWP ClientJourney plugin',
                    mermaid: `
                        flowchart TD
                            A[evolvewp-clientjourney/] --> B[includes/]
                            A --> C[admin/]
                            A --> D[assets/]
                            A --> E[api/]
                            A --> F[templates/]
                ...
                'class-hierarchy': {
                    ...
                    mermaid: `
                        flowchart TD
                            A[EvolveWPClientJourney] --> B[EvolveWP_CJ_Install]
                            A --> C[EvolveWP_CJ_Logger]
                            A --> D[EvolveWP_CJ_REST_Controller]
                            A --> E[EvolveWP_CJ_AI_Assistant]
                            
                            D --> F[EvolveWP_CJ_REST_Example]
                            D --> G[Custom REST Controllers]
                            
                            E --> H[EvolveWP_CJ_AI_Provider_Factory]
                            H --> I[EvolveWP_CJ_AI_Provider_Gemini]
                            H --> J[EvolveWP_CJ_AI_Provider_AmazonQ]
                ...
                'hook-system': {
                    ...
                    description: 'Actions and filters used throughout EvolveWP ClientJourney',
                    mermaid: `
                        flowchart LR
                            A[WordPress Init] --> B[evolvewp_cj_loaded]
                            B --> C[evolvewp_cj_init]
                            C --> D[admin_menu]
                            C --> E[rest_api_init]
                ...
                'logging-system': {
                    ...
                    mermaid: `
                        flowchart TD
                            A[Event Occurs] --> B[EvolveWP_CJ_Logger]
                            B --> C{Log Level}
                            C -->|Error| D[Error Log]
                            C -->|Info| E[Info Log]
                            C -->|Debug| F[Debug Log]
                            
                            D --> G[File: evolvewp-clientjourney-errors.log]
                            E --> H[File: evolvewp-clientjourney-info.log]
                            F --> I[File: evolvewp-clientjourney-debug.log]
                            
                            B --> J[Database Logger]
                            J --> K[wp_evolvewp_cj_logs table]
                ...
                'ai-integration': {
                    ...
                    mermaid: `
                        flowchart TD
                            A[AI Request] --> B[EvolveWP_CJ_AI_Assistant]
                            B --> C[EvolveWP_CJ_AI_Router]
                            C --> D{Task Type}
            ...
            $('#export-btn').on('click', function() {
                ...
                if (svg) {
                    ...
                    a.href = url;
                    a.download = 'evolvewp-clientjourney-diagram.svg';
                    a.click();
