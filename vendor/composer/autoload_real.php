...
// autoload_real.php — EvolveWP ClientJourney PSR-4 bootstrap.
//
...
// and add EvolveWP ClientJourney's PSR-4 prefix to it. If no ClassLoader exists yet (EvolveWP ClientJourney is
// the first plugin to load), create one and register it.

class ComposerAutoloaderInitEvolveWPClientJourney {

    /** @var \Composer\Autoload\ClassLoader|null */
    private static $loader = null;

    /**
     * Register the EvolveWP ClientJourney\ PSR-4 prefix with the active Composer ClassLoader.
     *
